...
class _Method:
    ...
    def __call__(self, *args, **kwargs):
        ...
        if result["success"]:
            ...
            raise Error(result["error_type"], result["message"],
                        result["traceback"])
...
class _MultiCallMethod:
    ...
    def __getattr__(self, name):
        return _MultiCallMethod(self.__call_list,
...
class ZeroRpcClient(object):
    def __init__(self, url_server,
        ...
        self.socket.connect(self.url_server)

        self.json_deserializer = json_serializer or json.dumps
